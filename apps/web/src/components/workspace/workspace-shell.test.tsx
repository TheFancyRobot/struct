...
describe('workspace shell', () => {
  ...
  it('renders one ordered navigation, main, and evidence surface without the legacy shell', () => {
    ...
    expect(html).toContain('aria-label="Open project search" aria-controls="project-search" aria-expanded="false"')
    expect(html).toContain('aria-label="Open source search" aria-controls="source-search" aria-expanded="false"')
    expect(html).not.toContain('placeholder="Search projects"')
    expect(html).not.toContain('placeholder="Search sources"')
    ...
    expect(html).not.toContain('Settings · Dark theme')
    expect(html).not.toContain('Source-grounded research with inspectable evidence.')
