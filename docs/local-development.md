...
| `VITE_API_WORKSPACE_ID` | `apps/web` browser bundle | workspace UUID used for workspace-qualified browser links; this is intentionally public and must match `API_WORKSPACE_ID` locally | local configuration |
