...
export const migrations: readonly Migration[] = [
  ...
  {
    name: '0014_research_dataset_citations',
    upPath: new URL('./0014_research_dataset_citations.sql', import.meta.url).pathname,
    downPath: new URL('./0014_research_dataset_citations.down.sql', import.meta.url).pathname,
  },
  {
    name: '0015_report_lifecycle',
  ...
  {
    name: '0017_durable_artifact_snapshots',
    upPath: new URL('./0017_durable_artifact_snapshots.sql', import.meta.url).pathname,
    downPath: new URL('./0017_durable_artifact_snapshots.down.sql', import.meta.url).pathname,
  },
  {
    name: '0018_project_lifecycle',
  ...
  {
    name: '0021_workspace_source_library',
  ...
  {
    name: '0023_attached_source_text_reindex',
    upPath: new URL('./0023_attached_source_text_reindex.sql', import.meta.url).pathname,
    downPath: new URL('./0023_attached_source_text_reindex.down.sql', import.meta.url).pathname,
  },
  {
    name: '0024_workspace_dataset_attachments',
