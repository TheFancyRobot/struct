...
- `packages/domain/src`: 15 files, 234 exported symbols, 30 internal symbols
- `packages/persistence/src/repositories`: 13 files, 111 exported symbols, 137 internal symbols
