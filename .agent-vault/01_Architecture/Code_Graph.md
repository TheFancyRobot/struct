...
- `packages/persistence/src/repositories`: 6 files, 57 exported symbols, 68 internal symbols
- `spikes/research-durability/src`: 4 files, 31 exported symbols, 91 internal symbols
- `packages/domain/src`: 6 files, 86 exported symbols, 4 internal symbols
...
- `packages/retrieval/src`: 1 files, 6 exported symbols, 25 internal symbols
