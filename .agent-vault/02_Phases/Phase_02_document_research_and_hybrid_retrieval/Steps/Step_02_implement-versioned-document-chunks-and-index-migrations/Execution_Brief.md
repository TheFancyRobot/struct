...
- `packages/persistence/src/migrations/0002_document_chunks.sql`
...
- Write the migration contract in `packages/persistence/src/migrations/0002_document_chunks.sql` and make the schema changes explicit about workspace scoping, immutable versioning, and foreign-key shape where relevant.
...
- Next, write the migration contract in `packages/persistence/src/migrations/0002_document_chunks.sql` and make the schema changes explicit about workspace scoping, immutable versioning, and foreign-key shape where relevant.
