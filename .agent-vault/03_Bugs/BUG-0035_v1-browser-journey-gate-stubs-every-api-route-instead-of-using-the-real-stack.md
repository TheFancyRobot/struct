...
related_notes:
  ...
  - '[[03_Bugs/BUG-0040_api-workspace-bootstrap-prevents-health-checks-during-database-outages|BUG-0040 API workspace bootstrap prevents health checks during database outages]]'
...
- 2026-07-24 - Closure blocked: full `bun run test` found the API startup health regression and research-replay ownership failure, tracked and fixed as BUG-0040 and BUG-0038; recursive evaluation harness headroom was subsequently fixed as BUG-0039.
