...
- Source attachment checkboxes have indistinguishable accessible names.
...
- **Observed:** Every global source row exposes a checkbox named only `Use in project`; two sources produce two identical checkbox names without source or project identity.
