...
- 2026-07-22 — During PR #61 validation, [[03_Bugs/BUG-0032_e2e-build-artifacts-break-canonical-lint-gate|BUG-0032 E2E build artifacts break canonical lint gate]] was confirmed and remediated with deterministic per-server bundle cleanup plus Git/ESLint safety ignores. BUG-0013 remains confirmed for later workflow slices; Phase 10 remains inactive.
...
- 2026-07-23: Implemented and validated the independently tracked unified three-pane workspace-shell remediation unit using STEP-10-02 as technical reference. BUG-0013 remains confirmed pending the source, conversation, evidence, notes, and complete browser-journey units.
- 2026-07-23: Completed the bounded source catalog/browser file-folder-paste import/activity remediation slice on `fix/BUG-0013-source-import`, using STEP-10-03 as technical reference only. Catalog truth now keys readiness to immutable versions, project activity replays durable ingestion events, and the browser can accept supported sources without blocking navigation. BUG-0013 remains confirmed; PHASE-10 and all STEP-10-* notes remain planned.
- 2026-07-23: Completed a bounded source-grounded conversation remediation slice using STEP-10-04 as technical reference only. The browser can start and continue one durable thread against selected ready immutable source versions, reload question/run history, preserve session-scoped drafts and explicit source scope, and replay streaming progress only after successful reduction. BUG-0013 remains confirmed; PHASE-10 and all STEP-10-* notes remain planned.
- 2026-07-23: Completed the bounded exact Evidence Inspector remediation slice using STEP-10-05 as technical reference only. Completed-run document and dataset citations now open their existing immutable evidence contracts in the workspace right pane with project/thread/run scope, query-string history restoration, accessible focus/close behavior, and text-only source rendering. BUG-0013 remains confirmed; PHASE-10 and all STEP-10 notes remain planned.
- 2026-07-23: Completed the bounded durable user-note remediation slice using STEP-10-06 as technical reference only. Terminal citation-backed answers can be saved idempotently as distinct editable notes; immutable document/dataset origin survives append-only revisions and reopens through the existing Evidence Inspector. BUG-0013 remains confirmed; PHASE-10 and all STEP-10 notes remain planned.
