...
# BUG-0081 - Disabled Reports destination is nearly invisible

Use one note per bug. Capture reproduction, impact, root cause, workaround, and verification, then link back to the relevant phase, step, decision, or session. See [[07_Templates/Note_Contracts|Note Contracts]].

## Summary

- Disabled Reports destination is nearly invisible.
...
- **Observed:** Disabled Reports text renders near alpha 0.2 in both project Conversation and Notes, making the destination appear absent rather than unavailable.
- **Expected:** Keep disabled controls clearly discoverable (roughly 0.4–0.5 emphasis) and pair with prerequisite guidance.
- **Evidence:** `.local/ui-audit/light/report.md` L-09.
